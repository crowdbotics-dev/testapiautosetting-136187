"""
Django settings for testapiautosetting_136187 project.
...
ROOT_URLCONF = 'testapiautosetting_136187.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136187.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsr2lu6 Support <support@testapiautosetting-136187.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136187 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136187 App",
    "VERSION": "v1",
}
